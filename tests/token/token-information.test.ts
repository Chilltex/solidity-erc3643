  ...
  describe(".setOnchainID()", () => {
    describe("when the caller is not the owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          token.connect(anotherWallet).setOnchainID(ethers.ZeroAddress)
        ).to.be.revertedWith("Ownable: caller is not the owner");
      });
    });
  ...
  describe(".setIdentityRegistry()", () => {
    describe("when the caller is not the owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          token.connect(anotherWallet).setIdentityRegistry(ethers.ZeroAddress)
        ).to.be.revertedWith("Ownable: caller is not the owner");
      });
    });
  });
  ...
  describe(".totalSupply()", () => {
    it("should return the total supply", async () => {
      ...
      const balance = await token
        ...
        .then(async (b) => b + (await token.balanceOf(bobWallet.address)));
  ...
  describe(".setCompliance", () => {
    describe("when the caller is not the owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          token.connect(anotherWallet).setCompliance(ethers.ZeroAddress)
        ).to.be.revertedWith("Ownable: caller is not the owner");
      });
    });
  });
