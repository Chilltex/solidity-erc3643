    ...
    describe("when sender is not owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          identityRegistryStorage
            .connect(anotherWallet)
            .bindIdentityRegistry(await charlieIdentity.getAddress())
    ...
    describe("when sender is agent", () => {
      ...
      describe("when identity registries not bound", () => {
        it("should revert", async () => {
          ...
          await expect(
            identityRegistryStorage
              .connect(deployer)
              .unbindIdentityRegistry(await identityRegistry.getAddress())
      ...
      describe("when identity registries is bound", () => {
        it("should unbind the identity registry", async () => {
          ...
          expect(
            await identityRegistryStorage.linkedIdentityRegistries()
          ).to.be.deep.equal([
            await identityRegistry.getAddress(),
            await bobIdentity.getAddress(),
          ]);
