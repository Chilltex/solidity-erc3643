        ...
        await expect(
          identityRegistry
            ...
            .updateIdentity(
              ...
              await charlieIdentity.getAddress()
            )
    ...
    describe("when sender is not an agent", () => {
      it("should revert", async () => {
        ...
        await expect(
          identityRegistry
            .connect(anotherWallet)
            .updateCountry(await bobIdentity.getAddress(), 100)
        ).to.be.revertedWith("AgentRole: caller does not have the Agent role");
      });
    });
  });
    ...
    describe("when sender is not an agent", () => {
      it("should revert", async () => {
        ...
        await expect(
          identityRegistry
            .connect(anotherWallet)
            .registerIdentity(ethers.ZeroAddress, ethers.ZeroAddress, 0)
        ).to.be.revertedWith("AgentRole: caller does not have the Agent role");
      });
    });
  });
    ...
    describe("when sender is not the owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          identityRegistry
            .connect(anotherWallet)
            .setIdentityRegistryStorage(ethers.ZeroAddress)
    ...
    describe("when sender is not the owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          identityRegistry
            .connect(anotherWallet)
            .setClaimTopicsRegistry(ethers.ZeroAddress)
        ).to.be.revertedWith("Ownable: caller is not the owner");
      });
    });
    ...
    describe("when sender is not the owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          identityRegistry
            .connect(anotherWallet)
            .setTrustedIssuersRegistry(ethers.ZeroAddress)
        ).to.be.revertedWith("Ownable: caller is not the owner");
      });
    });
  ...
  describe(".isVerified()", () => {
    describe("when there are no require claim topics", () => {
      it("should return true when the identity is registered", async () => {
        ...
        expect(await identityRegistry.isVerified(charlieWallet.address)).to.be
          .false;
    ...
    describe("when claim topics are required but there are not trusted issuers for them", () => {
      it("should return false", async () => {
        ...
        expect(await identityRegistry.isVerified(aliceWallet.address)).to.be
          .true;
    ...
    //       await trickyClaimIssuer.getAddress(),
    //       claimTopics
    //     );
    //     await trustedIssuersRegistry.addTrustedIssuer(
    //       await claimIssuerContract.getAddress(),
    ...
    //     expect(identityRegistry.isVerified(aliceWallet.address)).to.be.true;
    //   });
